...
const HELPER_TASKS: Record<string, string> = {
  ...
  audit_questions: 'Suggest internal audit questions relevant to this area against the laboratory\'s quality management requirements.',
...
export const SOP_TASKS: Record<string, { label: string; instruction: string }> = {
  ...
  missing_sections: { label: 'Identify missing sections', instruction: 'Against a standard SOP template (Purpose, Scope, Responsibility, Definitions, Materials/Equipment, Procedure, Quality Control/Safety, References, Records), identify which expected sections appear to be missing or weak in this SOP.' },
