...
export const FEATURES: FeatureDef[] = [
  ...
  { key: 'personnel.register', module: 'personnel', label: 'Personnel register', sensitive: true,
    desc: 'The master register of all staff — opening, adding and editing other people\'s records, and the staff file held for each person.',
    tabs: ['Master Personnel Register', 'Add Staff', 'Staff Files'] },
